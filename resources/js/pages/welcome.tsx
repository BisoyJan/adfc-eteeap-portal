...
const features = [
    {
        ...
        description:
            'Upload and organize your ETEEAP documents by category. Track your submission progress in real-time.',
        icon: FileUp,
    },
    {
        title: 'Expert Evaluation',
        description:
            'Qualified evaluators review your portfolio using standardized rubrics for fair and consistent assessment.',
        icon: ClipboardCheck,
    },
    {
        title: 'Track Progress',
        description:
            'Monitor your portfolio status from submission to approval. Receive instant notifications on updates.',
        icon: BarChart3,
    },
    {
        title: 'Secure & Transparent',
        description:
            'Your documents are securely stored. The entire process is transparent with clear status tracking.',
        icon: Shield,
    },
];
        ...
        <>
            ...
            <div className="min-h-screen bg-gray-50 dark:bg-neutral-950">
                ...
                <section className="relative isolate overflow-hidden">
                    ...
                    <div className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-white shadow-xl ring-1 shadow-indigo-600/5 ring-indigo-50 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center dark:bg-neutral-950 dark:shadow-indigo-400/5 dark:ring-neutral-800" />
                    ...
                    <div className="mx-auto max-w-4xl px-4 py-24 text-center sm:px-6 sm:py-32 lg:py-40">
                        ...
                        <p className="mt-4 text-lg font-medium text-indigo-600 sm:text-xl dark:text-indigo-400">
                            A Web-Based Portfolio & Evaluation System with
                            Progress Tracking
                        </p>

                        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-gray-600 sm:text-lg dark:text-gray-400">
                            Streamline your ETEEAP portfolio submission,
                            evaluation, and tracking process — all in one secure
                            digital platform.
                        </p>
                        ...
                        <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
                            {auth.user ? (
                                <Link
                                    href={dashboard()}
                                    className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-6 py-3 text-base font-semibold text-white shadow-md transition hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none dark:focus:ring-offset-neutral-950"
                                >
                                    Go to Dashboard
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="mx-auto max-w-2xl text-center">
                            ...
                            <p className="mt-4 text-base leading-relaxed text-gray-600 sm:text-lg dark:text-gray-400">
                                From submission to evaluation, every step is
                ...
                <footer className="border-t border-gray-200 bg-gray-50 dark:border-neutral-800 dark:bg-neutral-950">
                    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                        <p className="text-center text-sm text-gray-500 dark:text-gray-500">
                            &copy; 2026 Asian Development Foundation College.
                            ETEEAP Gateway.
                        </p>
                    </div>
                </footer>
