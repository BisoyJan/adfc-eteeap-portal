        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 p-6">
                <div className="flex items-center justify-between">
                    <Heading title="Document Categories" description="Manage portfolio document categories and requirements" />
                    <Button asChild>
                            ...
                            {categories.length === 0 ? (
                                ...
                                categories.map((category) => (
                                    <tr key={category.id} className="border-b last:border-0">
                                        ...
                                        <td className="px-4 py-3 text-muted-foreground">{truncate(category.description)}</td>
                                        ...
                                        <td className="px-4 py-3 text-center text-muted-foreground">{category.documents_count}</td>
                                        <td className="px-4 py-3">
                                            <div className="flex items-center justify-end gap-1">
                                                <Button variant="ghost" size="sm" asChild>
                                                    <Link href={`/admin/document-categories/${category.id}/edit`}>
            ...
            <AlertDialog open={deleteDialogOpen} onOpenChange={(open) => { setDeleteDialogOpen(open); if (!open) setCategoryToDelete(null); }}>
                <AlertDialogContent>
                    <AlertDialogHeader>
